...
export default async function IndexPage() {
  // Using invitation-only model with NextAuth.js

  return (
    <>
      <Hero
        capsuleText="100% Open-source & Free"
        capsuleLink="https://github.com/glampinski/multi-tenant-starter-template"
        title="Invitation-Only Multi-tenant Starter"
        subtitle="Built for referral-based businesses. Next.js + Shadcn UI + NextAuth.js with invitation system."
        primaryCtaText="Invitation Only"
        primaryCtaLink="#invitation-info"
        secondaryCtaText="GitHub"
        secondaryCtaLink="https://github.com/glampinski/multi-tenant-starter-template"
        credits={
          <>
            Powered by{" "}
            <a
      ...
      <FeatureGrid
        ...
        items={[
          ...
          },
          {
            ...
            title: "NextAuth.js",
            description:
              "Flexible Authentication: Email magic links, invitation system, and secure sessions.",
          },
          {
            icon: <Users className="h-12 w-12" />,
            title: "Invitation-Only & RBAC",
            description: "Referral-based signup with role-based access control and lineage tracking.",
          },
          {
